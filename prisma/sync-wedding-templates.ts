...
const weddingTemplates: TemplateUpsertData[] = [
  {
    ...
    domain: 'wedding',
    preview_image_url:
      'http://123.57.16.107:9000/ai-images/templates/1760497311322-71572191-c235-4fc4-8104-b096f8695350.png',
    prompt_config: {
      steps: 1,
      basePrompt: '',
      negativePrompt: '',
  ...
  },
  {
    ...
    domain: 'wedding',
    preview_image_url:
      'http://123.57.16.107:9000/ai-images/templates/1760495218630-2e31e461-488f-4832-9186-ec0a7df40372.png',
    prompt_config: {
      basePrompt: '',
      negativePrompt: '',
      styleModifiers: ['韩式风格'],
  ...
  },
  {
    ...
    domain: 'wedding',
    preview_image_url:
      'http://123.57.16.107:9000/ai-images/templates/1760498454574-5d62bb34-3b7c-45a2-8630-01a8205b7325.png',
    prompt_config: {
      basePrompt: '',
      negativePrompt: '',
      styleModifiers: [],
  ...
  },
  {
    ...
    domain: 'wedding',
    preview_image_url:
      'http://123.57.16.107:9000/ai-images/templates/1760508287896-d7c2fa28-b5a3-4b97-9184-7e00f01244db.png',
    prompt_config: {
      basePrompt: '',
      negativePrompt: '',
      styleModifiers: [],
  ...
  },
  {
    ...
    domain: 'wedding',
    preview_image_url:
      'http://123.57.16.107:9000/ai-images/templates/1762159498865-e9cb5d5d-442a-448a-acd8-b1d64491f006.png',
    prompt_config: {
      basePrompt: '',
      negativePrompt: '',
      styleModifiers: [],
  ...
  },
  {
    ...
    domain: 'wedding',
    preview_image_url:
      'http://123.57.16.107:9000/ai-images/templates/1762159993200-f4370ca9-d9e7-4b96-885e-c946ab001abf.png',
    prompt_config: {
      basePrompt: '',
      negativePrompt: '',
      styleModifiers: [],
  ...
  },
  {
    ...
    domain: 'wedding',
    preview_image_url:
      'http://123.57.16.107:9000/ai-images/templates/1762160875487-34c26171-b0cc-49f7-bd0a-db2c6900191e.png',
    prompt_config: {
      basePrompt: '',
      negativePrompt: '',
      styleModifiers: [],
...
async function main() {
  ...
  console.log(`Syncing ${weddingTemplates.length} wedding templates...`);

  // Check which IDs already exist
  const existingIds = new Set(
    (
      await prisma.templates.findMany({
        where: { id: { in: weddingTemplates.map((t) => t.id) } },
        select: { id: true },
      })
    ).map((t) => t.id)
  );
  ...
  for (const tpl of weddingTemplates) {
    const isNew = !existingIds.has(tpl.id);
    ...
    await prisma.templates.upsert({
      ...
      update: {
        ...
        prompt_config: tpl.prompt_config,
        prompt_list: tpl.prompt_list,
        price_credits: tpl.price_credits,
    ...
    if (isNew) {
      ...
      updated++;
      console.log(`  [UPD] ${tpl.name}`);
    }
  }

  console.log(
    `\nDone! Created: ${created}, Updated: ${updated}, Total: ${weddingTemplates.length}`
  );
