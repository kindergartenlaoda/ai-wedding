...
项目提供一键部署脚本，支持 **Windows** 和 **macOS / Linux** 双平台。
...
A: 推荐使用 Docker 一键部署脚本。详见 [DEPLOYMENT.md](./DEPLOYMENT.md)。

**Q: Windows 运行脚本报错？**

A: 以管理员身份运行 PowerShell，执行 `Set-ExecutionPolicy -Scope CurrentUser -ExecutionPolicy RemoteSigned`
